...
# Creating strategies
mean_variance_strategy = portfolio_strategies.MeanVarianceStrategy(fama_french_portfolios.filter(pl.col("N_Portfolios") == 6), ["Tech Stocks", "Small Cap", "RF"])

sharpe_optimized = mean_variance_strategy.running_optimal_sharpe_portfolio(3 * 12, full_frontier = False)
