...
The product design in Best Pensions currently reflects the high degree of dependence towards providing the promised guarantees at termination of the Target Date Funds (TDF).
Based on the analysis it is strongly recommended to revise the balance between allocation to an active fund and TDF's.
\textcolor{red}{In particular we recommend that Best Pensions decreases $L_{target}$ to and converts to a CPPI strategy with multiply of $m$. Further we recommend that Best Pensions allows for investments in foreign markets for the active portfolio.}
...
Based on the analysis we recommend that for the active fund Best Pensions invests in the following assets: \textcolor{red}{assets}. The allocation should be based on an \textcolor{red}{strategy}.
...
\include{PreliminaryActiveRecom}
